...
interface DepartmentListProps {
  ...
  onResetHospital: (supervisorNationalId: string, supervisorPassword: string) => Promise<boolean>;
  onContactAdmin: () => void;
  userRole: UserRole;
}
...
const DepartmentList: React.FC<DepartmentListProps> = ({
  ...
  const handleConfirmReset = async () => {
    setResetError(null);
    const success = await onResetHospital(supervisorIdInput, supervisorPasswordInput);
    if (success) {

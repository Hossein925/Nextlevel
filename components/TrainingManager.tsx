...
interface TrainingManagerProps {
  ...
  onAddMaterial: (month: string, file: File, description: string) => void;
...
const TrainingManager: React.FC<TrainingManagerProps> = ({ monthlyTrainings, onAddMaterial, onDeleteMaterial, onUpdateMaterialDescription, onBack }) => {
    ...
    const handleSaveMaterialWithDescription = () => {
      // FIX: Changed to pass the File object directly, instead of creating an invalid TrainingMaterial object with a 'data' property.
      if (pendingFile) { // Adding new
          const { file } = pendingFile;
          onAddMaterial(selectedMonth, file, materialDescription.trim());
